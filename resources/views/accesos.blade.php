    ...
    <section class="content">
        ...
        <div class="header">
          ...
          <div class="dashboardCard">
            ...
            <div class="iconos-navi-container">
                <div class="iconos-navi">
                    <i class="fa-solid fa-bell"></i> <!-- Icono de notificación -->
                    <div class="dropdown-content">
                        <p>No tienes nuevas notificaciones</p>
                        <!-- Aquí puedes agregar más contenido o un enlace -->
                    </div>
                </div>
                <div class="iconos-navi">
                    <i class="fa-solid fa-envelope"></i> <!-- Icono de mensaje -->
                    <div class="dropdown-content">
